                  ...
                  <div class="container-fluid">
                     ...
                     <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav menu-list">
                           <li class="<?php if(isset($active_menu) && $active_menu=="home") echo "active";?>"><a href="<?php echo base_url();?>">Home</a></li>
                           <li class="<?php if(isset($active_menu) && $active_menu=="aboutus") echo "active";?>"><a href="<?php echo base_url(); ?>welcome/aboutus">  About Us  </a></li>
                           <li class="<?php if(isset($active_menu) && $active_menu=="contactus") echo "active";?>"><a href="<?php echo base_url(); ?>welcome/contact">Contact Us</a></li>
