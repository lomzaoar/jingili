                     ...
                     <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                           <ul class="nav navbar-nav">
                              <li><a href="<?php echo base_url();?>user/profile"><i class="fa fa-user"></i> Account</a></li>
                              <li class="dropdown">
                                 <a href="<?php echo base_url();?>user/logout" class="dropdown-toggle" > <i class="fa fa-lock"></i> Logout </a>        
                              </li>
                           </ul>
                        </div>
                        <!-- /.navbar-collapse -->
