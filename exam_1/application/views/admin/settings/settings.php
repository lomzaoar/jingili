...
<div class="row">
   <div class="col-md-8">
      ...
      <form method="POST" action="<?php echo base_url();?>admin/settings" id="settings_form" enctype="multipart/form-data">
         ...
         <div class="form-group">
            <label for="inputEmail">Passing Score</label>
            <?php 
               $val = '';
            ...
            ?>
            <input type="text" class="form-control" id="passing_score" name="passing_score" value="<?php echo $val;?>" placeholder="Enter Passing Score" >
         </div>
