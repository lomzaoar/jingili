      ...
      <table id="example" class="cell-border" cellspacing="0" width="100%">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td>
                  <a href="<?php echo base_url();?>admin/addeditQuestions/<?php echo $r->questionid;?>/<?php echo $r->subjectname;?>" class="btn bg-primary wnm-user"> <i class="fa fa-edit"></i> Edit</a>
