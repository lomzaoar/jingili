      ...
      <div class="col-md-8 col-xs-12">
         ...
         <div class="col-md-12 formgro">
            ...
            <div <?php if(!isset($notificationTitle)) { ?> style="border-bottom:1px dashed #ccc;margin-bottom:15px;margin-top: -10px;" <?php } ?>>
               Post Date: <?php echo date('d-m-Y',strtotime($n->post_date));?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
               <p style="float:right;">Last Date: <?php echo date('d-m-Y',strtotime($n->last_date));?></p>
            </div>
            <?php if(isset($notificationTitle)) echo "<br/><a style='float:right;margin-top: 20px;' href='".base_url()."welcome/notifications'>View all Notifications</a>"; ?>
            <?php } } ?>
         </div>
      </div>
